---
name: "speckit-gate"
description: "Run the 28-repo four-gate convergence check (ruff incremental + pytest + industrial grade + data validity). This is the ONLY definition of 'done' for speckit implement/converge in this repository."
argument-hint: "none — collects changed files and pytest scope itself"
compatibility: "Requires spec-kit project structure with .specify/ directory"
metadata:
  author: "local-28repo"
  source: "cairn/spec-kit-sdd-integration-20260911.md §5"
user-invocable: true
