...
try:
    ...
    print(f"  [PASS] factor_library 验证通过 (>=9 价格类因子)")
    ...
    print(f"  [PASS] factor_library 基本面因子验证通过")
except Exception as e:
...
try:
    ...
    print(f"  ✓ daily_workflow.py 语法检查通过")
    # 验证关键修复点
    ...
    print(f"  ✓ 导入路径已修复: utils.signal_fusion.SignalFusionEngine")
    print(f"  ✓ forward_returns 注入点已添加")
    print(f"  [PASS] daily_workflow 验证通过")
except Exception as e:
