...
## TIME PROGRESS（时间进度条，快照 2026-09-12）

> 口径 = **窗口时间已过占比**（非工作量完成度），刷新即新快照、不追溯改写。**非权威** —— 权威状态见上方 `CURRENT STATE` YAML；本块百分比与 `docs/排期计划总览_20260912.md` §1.1 / §1.2 **同源**（完整版含日级续窗 / 里程碑倒计时 / 决策队列）。

```text
整体  Stage A 09-03 ─▶ 策略六线末 2027-06-30
      [▌░░░░░░░░░░░░░░░░░░░]   3.0%   已过 9/301 天 · 今日 09-12（周六）
      阶段刻度：09-19 冻结窗 5.3% · 10-13 评估计算 13.3% · 12-10 功能冻结 32.6% · 12-31 发布 39.9% · 01-02~09 生产切换窗 40.5~42.9% · 03-31 Q1 收口 69.8%

其中 v8.7 发布段（09-03 → 12-31）
      [█▌░░░░░░░░░░░░░░░░░░]   7.5%   已过 9/120 天 · 今日 09-12（周六）

Wave 2 Phase B        [████████████████████] 100%  ✅ 09-11 收口（B4 双签）
Wave 7-QC 代码质量     [████████████████████] 100%  ✅ 09-08 关闭（提前 13 天）
Wave 7 统一整合 S1-S4  [████▎░░░░░░░░░░░░░░░]  21%  🔄 S2 09-14
ETF S12 P3.2 影子      [████████▍░░░░░░░░░░░]  42%  🔄 10-13 评估
Shadow admission 21d  [███▊░░░░░░░░░░░░░░░░]  19%  🔄 至 09-28
Wave 7-ERL 进化再平衡   [█▏░░░░░░░░░░░░░░░░░░]   6%  ⏳ 双签 09-13~18
Shadow 30 天 MVSK/GNN [░░░░░░░░░░░░░░░░░░░░]   0%  ⏳ 09-13 首日
对冲基金模式 shadow    [░░░░░░░░░░░░░░░░░░░░]   0%  ⏳ 09-19 P1/P2
资金线 Sprint3 灰度    [░░░░░░░░░░░░░░░░░░░░]   0%  ⏳ 09-18 解锁 S3-1
发布窗 Stage C        [░░░░░░░░░░░░░░░░░░░░]   0%  ⏳ 12-10~12-31
生产切换窗 2027       [░░░░░░░░░░░░░░░░░░░░]   0%  ⏳ 2027-01-02~09

倒计时：09-14 S2 启动（2 天）· 09-17 D11 20/20（5 天）· 09-18 D11 复验 + ER-2.x 截止（6 天）
        · 09-19 冻结窗生效（7 天）· 12-10 功能冻结（89 天）· 12-31 v8.7 发布（110 天）
── 2027 段（整体条后半程，窗口见 §2027 PLAN / §策略六线）──
v8.7.1 Core 01~03      [░░░░░░░░░░░░░░░░░░░░]   0%  ⏳ G4 Alpha Registry 01 月 / G3 regime 02-15~03-07 shadow → 03 月启用决策
GitHub Waves 01~06     [░░░░░░░░░░░░░░░░░░░░]   0%  ⏳ 9-GH 01-04~04-30 / 10-CTX B 05-03~06-28 / 11-B/C 收 02-28 / 12-B 收 03-21（错峰）
PLG Batch1~3 / 期货 100 万 [░░░░░░░░░░░░░░░░░░░░]   0%  ⏳ B1 ≥01-04（R-8）· B2 Q1~Q2 · B3 挂 9/11/12 + TimesFM 03 月 POC · Q1 开户接入（R-12）
增强线 v9.2 卫星+卖方   [░░░░░░░░░░░░░░░░░░░░]   0%  ⏳ Q1~Q2 影子（超额 ≥2%）→ Q3 上线 · Kill: 影子超额 <1% 归档
```

### 时间轴（甘特 · 月轴定位，快照 2026-09-12）

> **与上方进度条同源**：本块由 `scripts/roadmap_timeline.py` 从下方 **TRACKS 表**渲染，**非手写**（手写必然与表漂移）。
> 图例：`█` 窗口已过 · `░` 窗口未到 · 轴首行 = 年份、次行 = 两位月刻度 · `╪` 年界 · 条后括号 = 窗口起止 · 行尾 = 状态图标 + 备注。
> **✅ 行按实际关闭取全填**（提前关闭不显示剩余窗口，与 `docs/排期计划总览_*.html §1.2` 同口径）。
> 刷新 = `python scripts/roadmap_timeline.py --write --mirror docs/排期计划总览_20260912.md`；漂移门禁 = `--check`（不一致 RC=1）。
...
### 轨道窗口表（TRACKS —— 甘特唯一数据源）

> 字段 = `group|名称|起|止|状态|备注`；group ∈ total/stage/q4/y2027；状态 ∈ done/run/wait/block。
> **日期口径**：q4 行取自 `docs/排期计划总览_20260912.html` §1.2 的权威窗口（与该文件同源）；y2027 行为 **月级锚点推导**，已在备注标注，粗粒度不精确到日。
> **改动规则**：改本表 → 必须同轮跑 `--write` 刷新甘特；表与甘特不一致 = 文档缺陷（`--check` 会拦）。

<!-- TIMELINE-TRACKS:BEGIN -->
```text
total|① 整体（Stage A → 策略六线末）|2026-09-03|2027-06-30|run|已过 9/301 天 ≈ 3.0%
total|② v8.7 发布段|2026-09-03|2026-12-31|run|已过 9/120 天 ≈ 7.5%
stage|Stage A 冻结前|2026-09-03|2026-09-18|run|D11 复验 09-18 → 解锁 Sprint3-1
stage|Stage B 冻结窗|2026-09-19|2026-12-10|wait|R-4 Change Budget 生效（shadow 照常）
stage|Stage C 发布窗|2026-12-10|2026-12-31|wait|RC-1 → RC-2 锁定 → rehearsal
stage|生产切换窗（R-3 独立窗）|2027-01-02|2027-01-09|wait|独立 Go/No-Go + 独立回滚，逐项不捆绑
q4|Wave 2 Phase B|2026-08-20|2026-09-11|done|B1✅ B2✅ B3✅ B4✅（09-11 双签收口）
q4|Wave 7-QC 代码质量|2026-08-22|2026-10-05|done|09-08 关闭（提前 13 天）
q4|Wave 7 统一整合 S1-S4|2026-08-13|2026-12-31|run|S1✅ → S2 09-14 → S3 → S4 → 12-31 发布
q4|ETF S12 P3.2 影子|2026-08-20|2026-10-13|run|NAV 1.0117 → 10-13 统一评估
q4|Shadow admission 21 天|2026-09-08|2026-09-28|run|三模块准入判定
q4|Wave 7-ERL 进化→再平衡|2026-09-05|2026-12-31|run|ER-2.x 双签 09-13~18；ER-3.x 冻结窗只观察
q4|Shadow 30 天 MVSK / GNN|2026-09-13|2026-10-12|wait|09-13 首日 → 10-13 计算
q4|对冲基金模式 shadow|2026-09-19|2026-12-10|wait|P1/P2 启动
q4|资金线 Sprint3 灰度|2026-09-18|2027-01-09|wait|S3-1 20万 → S3-2 100万 shadow 30天 → S3-3 切换窗
y2027|v8.7.1 Core / Hardening|2027-01-01|2027-03-31|wait|G4 Alpha Registry 01 月；G3 shadow 02-15~03-07 → 03 月启用决策（月级锚点）
y2027|GitHub Waves 9/10/11/12|2027-01-04|2027-06-28|wait|9-GH 01-04~04-30；10-CTX B 05-03~06-28；11-B/C 错峰收口（月级锚点）
y2027|PLG Batch 1~3|2027-01-04|2027-06-30|wait|B1 ≥01-04；B2 Q1~Q2；B3 挂 9/11/12 + TimesFM 03 月 POC（月级锚点）
y2027|期货 100 万开户 / 接入|2027-01-01|2027-03-31|wait|R-12（Q1，月级锚点）
y2027|增强线 v9.2 卫星 + 卖方|2027-01-01|2027-09-30|wait|Q1~Q2 影子（超额 ≥2%）→ Q3 上线；Kill: 影子超额 <1% 归档（Q3 末为月级推导）
```
<!-- TIMELINE-TRACKS:END -->
...
| **F5-c：515080（中证红利ETF）期权合约可得性**（P0；v9.5 权益层 15% 保护路径） | 用户 | 09-18 | 已核（09-13）：AKShare 权威 symbol 全集无「中证红利ETF期权」（空表 ≠ 无合约）；补充公开检索亦未见挂牌证据 ⇒ 须交易所/券商侧书面确认。若确认无合约 ⇒ 方案层三选一：接受裸暴露 / 510300 交叉对冲（显式计基差风险）/ 调整标的。依据 `300万计划/v9.5量化系统接入方案_20260913.md` §5.7 F5-c |
...
| 建仓流水处置：每日 09:00 盘前流返回假「已完成」（计划文件路径分裂） | 用户（恢复建仓 / 停用任务） | 尽快 | 已复现；0912 续批确认 SC-1 已修复（b8eff0aa → 显式错误态 TradePlanUnavailableError，不再假「已完成」），处置决策仍待拍板；另按 v9.5 接入 §5.7 F6 登记：若恢复建仓，须同步校准 `config/trade_execution.yaml` `stock_etf_target`（现 300 万属 5M 旧建仓口径链；R-11 证券腿 = 200 万）——改值或显式标注历史口径；详见 docs/代码质量与系统Bug审查_20260911.md §P1-1 |
| **v9.5 子组合资金到位与分期**（拟编号 R-13） | 用户 | Stage D 排期审查前（拟） | 三项登记：① 本子组合金额与 capital_base 关系 = 不并入、不参与 resolve_effective_capital；② 资金来源 = 从 S3-3 的 200 万内划拨（非新增总敞口）；③ 批一分期与挂靠时点。未拍板 ⇒ 批一不启动（停留 shadow），不阻塞其它线。依据 `300万计划/v9.5量化系统接入方案_20260913.md` §5.7 F2 |
...
| 主题 | 载体 |
|------|------|
| **排期计划总览 r9.5（时间进度条 + 续排日历 + 导航，09-12 快照）** | `docs/排期计划总览_20260912.md`（可视化版 `docs/排期计划总览_20260912.html`）— 导航/续排层；百分比与上方 `§TIME PROGRESS` **同源**，冲突以本文 `CURRENT STATE` + `cairn/LOG.md` 为准。刷新锚点 = D11 复验后（09-18）或统一评估周判定后（10-16），取早者 |
...
> **每日查看路径**：CURRENT STATE → TIME PROGRESS → DECISION NEEDED → NEXT 14 DAYS → RELEASE GATES → CURRENT QUARTER（含开放问题）。
