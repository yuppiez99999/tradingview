...
sys.path.insert(0, str(BASE_DIR / "v7.5_institutional" / "src"))
...
class DailyBuildHedgeSystem:
    ...
    def generate_build_instructions(self, phase: Dict) -> Dict[str, Any]:
        ...
        if any(info.get("style") == "宽基" or info.get("adjustable")
    ...
    def fetch_realtime_quotes(self) -> Dict[str, Any]:
        ...
        try:
            ...
            quotes = get_realtime_quotes(sorted(codes))
    ...
    def generate_report(self) -> str:
        ...
        lines.append(f"- **20日收益率**: {_ir20:.2%}" if isinstance(_ir20, (int, float)) else f"- **20日收益率**: {_ir20}")
