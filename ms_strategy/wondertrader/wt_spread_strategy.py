...
class SpreadStrategy(ABC):
    ...
    def on_trade(self, ctx: SpreadContext, trade: TradeData) -> None:  # noqa: B027 - 可选回调钩子, 非抽象方法
        """成交回调 — 可选钩子, 子类按需重写"""
        ...

    def on_position(self, ctx: SpreadContext, position: float) -> None:  # noqa: B027 - 可选回调钩子, 非抽象方法
        """持仓回调 — 可选钩子, 子类按需重写"""
        ...
...
class SpreadBacktester:
    ...
    def _generate_report(self) -> dict:
        ...
        self.ctx.cash if not self.equity_curve else \
