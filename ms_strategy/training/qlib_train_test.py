...
# 将项目根目录加入 sys.path，使根目录下的 qlib/ 源码包可被导入
# （本环境 qlib 未安装进 venv，而是以源码形式置于项目根目录）
...
def main():
    ...
    DATA_START = "2018-01-01"  # noqa: N806
    DATA_END = "2026-07-01"  # noqa: N806
    TRAIN_END = "2024-06-30"  # noqa: N806
    VALID_END = "2025-06-30"  # noqa: N806
    TEST_START = "2025-07-01"  # noqa: N806

    print(f"\n{'='*70}")
    print("QLib 横截面模型训练 — 持仓标的 (25只)")
    print(f"{'='*70}")
