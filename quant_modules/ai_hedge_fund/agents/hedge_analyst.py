...
1. **Nassim Taleb** — 尾部风险专家: 关注黑天鹅事件、反脆弱性、凸性收益、杠铃策略。核心问题:
"这个组合在极端市场环境下会怎样？"
2. **Michael Burry** — 大空头: 关注市场估值泡沫、系统性风险、非对称做空机会。核心问题:
"市场是否被高估？是否存在做空机会？"
3. **Stanley Druckenmiller** — 宏观投资者: 关注宏观经济周期、央行政策、资金流向、跨资产联动。核心问题:
"宏观环境是否支持当前持仓？"
