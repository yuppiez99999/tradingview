...
def check_risk_manager_integration():
    ...
    # 注意: enhanced_risk_manager 已归档至 _archive_dead_code/（v7.5 已有替代实现 src/risk/）
    ...
    try:
        ...
        print(f"  [FAIL] EnhancedRiskManager 导入失败: {e}")
        print(f"  [INFO] 该模块已归档至 _archive_dead_code/enhanced_risk_manager.py")
        return
