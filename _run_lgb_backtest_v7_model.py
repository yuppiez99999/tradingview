...
print(f"V7-Model 新增特征: 8 个 regime-aware (4 dummy + 2 大盘指标 + 2 交互项)")
print(f"V7-Model 核心交互: vol20_x_bull, mom20_x_bull")
print(f"止盈规则: 单标的>50%→×0.6, 组合>12%→×0.80 (与V6.2一致)")
print(f"模式: resume=False (强制LGB重训, 应用新特征)")
print()
