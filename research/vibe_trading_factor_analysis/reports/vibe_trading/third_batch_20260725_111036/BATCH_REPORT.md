# 首批次流水线跑批报告 - third_batch_20260725_111036

> CIO 视角批次质量评估（v1.0）
> 生成时间：2026-07-25 11:10:39

## 1. 批次基本信息

| 项目 | 值 |
|------|----|
| batch_id | `third_batch_20260725_111036` |
| 开始时间 | 2026-07-25T11:10:36.805033 |
| 结束时间 | 2026-07-25T11:10:39.605080 |
| 数据标的数 | 23 |
| 候选因子总数 | 16 |
| n_trials (多重检验基数) | 23 |
| portfolio_value | 1e8 |
...
| Gate | 通过数 | 通过率 | 说明 |
|------|--------|--------|------|
| G1 正交性 | 4 | 25.0% | 与现有 50+ 因子相关性 \|corr\| < 0.5 |
...
完整流水线状态持久化于：
```
reports/vibe_trading/third_batch_20260725_111036/pipeline_state.json
```
