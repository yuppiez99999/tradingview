# 第八批次流水线跑批报告 - eighth_batch_20260725_132019

> CIO 视角批次质量评估（P2.1b 反向信号因子增强）
> 生成时间：2026-07-25 13:20:35

## 1. 批次基本信息

| 项目 | 值 |
|------|----|
| batch_id | `eighth_batch_20260725_132019` |
| 开始时间 | 2026-07-25T13:20:19.427796 |
| 结束时间 | 2026-07-25T13:20:35.623602 |
| 数据标的数 | 105 |
| 候选因子总数 | 20 |
| n_trials (多重检验基数) | 105 |
| portfolio_value | 1e8 |
...
完整流水线状态持久化于：
```
reports/vibe_trading/eighth_batch_20260725_132019/pipeline_state.json
```
