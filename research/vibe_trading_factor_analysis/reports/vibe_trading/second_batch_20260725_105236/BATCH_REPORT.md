# 首批次流水线跑批报告 - second_batch_20260725_105236

> CIO 视角批次质量评估（v1.0）
> 生成时间：2026-07-25 10:52:39

## 1. 批次基本信息

| 项目 | 值 |
|------|----|
| batch_id | `second_batch_20260725_105236` |
| 开始时间 | 2026-07-25T10:52:36.561156 |
| 结束时间 | 2026-07-25T10:52:39.864642 |
| 数据标的数 | 23 |
| 候选因子总数 | 16 |
| n_trials (多重检验基数) | 23 |
| portfolio_value | 1e8 |
...
| 4 | `VT_MOM_HIGH_LOW_60D` | rejected | 0.687 | 0.046 | - | - | - | - | -/- | - |
| 5 | `VT_REV_SHORT_TERM` | rejected | 1.000 | - | - | - | - | - | -/- | - |
| 6 | `VT_REV_VOLUME_SPIKE` | rejected | 0.954 | - | - | - | - | - | -/- | - |
| 7 | `VT_REV_OVERREACTION` | rejected | 0.535 | -0.132 | - | - | - | - | -/- | - |
...
完整流水线状态持久化于：
```
reports/vibe_trading/second_batch_20260725_105236/pipeline_state.json
```
