# 第六批次流水线跑批报告 - sixth_batch_20260725_120601

> CIO 视角批次质量评估（P1.1+P1.2+P1.3 改进验证）
> 生成时间：2026-07-25 12:06:09

## 1. 批次基本信息

| 项目 | 值 |
|------|----|
| batch_id | `sixth_batch_20260725_120601` |
| 开始时间 | 2026-07-25T12:06:01.442005 |
| 结束时间 | 2026-07-25T12:06:09.043746 |
| 数据标的数 | 105 |
| 候选因子总数 | 16 |
| n_trials (多重检验基数) | 105 |
| portfolio_value | 1e8 |
...
| 2 | `VT_MOM_OVERNIGHT_GAP` | rejected | 0.419 | -0.300 | - | - | - | - | -/- | - |
| 3 | `VT_MOM_AUTOCORR_5D` | rejected | 0.312 | -0.216 | - | - | - | - | -/- | - |
| 4 | `VT_MOM_HIGH_VOL_ALPHA` | rejected | 0.303 | -0.178 | - | - | - | - | -/- | - |
| 5 | `VT_REV_BREADTH_5D` | rejected | 0.529 | 0.050 | - | - | - | - | -/- | - |
| 6 | `VT_REV_VOL_DRAIN` | rejected | 0.444 | 0.001 | - | - | - | - | -/- | - |
| 7 | `VT_REV_OVERREACTION` | rejected | 0.516 | -0.079 | - | - | - | - | -/- | - |
| 8 | `VT_LIQ_AMIHUD_SCALED` | rejected | 0.608 | -0.240 | - | - | - | - | -/- | - |
| 9 | `VT_LIQ_TURNOVER_REGIME` | rejected | 0.646 | -0.073 | - | - | - | - | -/- | - |
| 10 | `VT_VOL_OVERNIGHT_RATIO` | rejected | 0.381 | 0.201 | - | - | - | - | -/- | - |
...
完整流水线状态持久化于：
```
reports/vibe_trading/sixth_batch_20260725_120601/pipeline_state.json
```
