...
def main() -> int:
    ...
    print("=" * 70)
    print("S3 第七批次流水线跑批（P2.1 微观结构因子验证）")
    print("=" * 70)
    print("P2.1 改进内容:")
    print("  新增 7 个微观结构因子 (VT_MICRO_* + VT_REV_VOL_DRAIN_INV)")
    print("  移除 4 个共线 V/Q/S 因子 (max_corr >= 0.99)")
    print("  保留 VT_GROWTH_COMPOSITE (P1 实测 IC_IR=+0.26 最高分)")
    ...
    print("\n" + "=" * 70)
    print("S3 第七批次流水线跑批完成（P2.1 微观结构因子验证）")
    print("=" * 70)
    return 0
