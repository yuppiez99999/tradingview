# -*- coding: utf-8 -*-
"""
QLib v7训练脚本 — 增强正则化 + Top40特征 + 扩展训练样本(CSI100)
"""
import os
import sys
import json
...
CSI100_AUX = [
    ...
    ("000625", "SZ", "长安汽车"), ("600104", "SH", "上汽集团"),
    ("601601", "SH", "中国太保"), ("601328", "SH", "交通银行"),
    ("601288", "SH", "农业银行"), ("601818", "SH", "光大银行"),
    ("002142", "SZ", "宁波银行"), ("601169", "SH", "北京银行"),
    ("002024", "SZ", "苏宁易购"), ("600703", "SH", "三安光电"),
    ("000895", "SZ", "双汇发展"), ("601988", "SH", "中国银行"),
    ("600196", "SH", "复星医药"), ("600837", "SH", "海通证券"),
    ("600309", "SH", "万华化学"), ("601628", "SH", "中国人寿"),
]
...
def main():
    ...
    print("训练XGBoost模型(v7, flush=True)...")
    ...
    print(f"\n{'='*70}", flush=True)
    print(f"XGBoost v7 (Top{TOP_N}特征+增强正则化, flush=True) 训练完成")
    ...
    report_path = os.path.join(reports_dir, f"qlib_v7_train_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.json")
