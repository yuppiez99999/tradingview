...
for line in lines:
    ...
    if "178.16 万" in line:
        line = line.replace("178.16 万", "153.35 万")
    if "180.30 万" in line:
        line = line.replace("180.30 万", "154.18 万")
...
print("[OK] 已剔除 000792/601318/000858，并同步 500万建仓计划 / trade_plan JSON / trade_plan MD / ifind_watchlist CSV")
