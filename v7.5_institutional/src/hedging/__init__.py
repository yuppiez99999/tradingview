...
# v5.9增强对冲
try: from .hedge_engine_v59 import HedgeEngine, PortfolioRisk, HedgeRecommendation
except ImportError: HedgeEngine = None; PortfolioRisk = None; HedgeRecommendation = None
try: from .hedge_rebalance_v59 import HedgeRebalanceIntegrator
except ImportError: HedgeRebalanceIntegrator = None
...
__all__ = ["BetaHedger", "VolHedger", "CorrelationHedger", "HedgeCoordinator",
           "HedgeEngine", "PortfolioRisk", "HedgeRecommendation", "HedgeRebalanceIntegrator",
           "MultiLayerHedgeManager", "SmartHedgeTrigger", "TailRiskHedge",
           "VolatilityHedge", "EnhancedDeltaHedge"]
