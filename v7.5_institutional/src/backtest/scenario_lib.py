...
class ScenarioLibrary:
    ...
    # ---------- What-If ----------
    def what_if(self, positions: dict, scenario_name: str,
        ...
        total_nlv = sum(current_prices.get(s, 0) * abs(q)
    ...
    # ---------- Monte Carlo ----------
    def monte_carlo_tail(self, positions: dict, prices: dict,
