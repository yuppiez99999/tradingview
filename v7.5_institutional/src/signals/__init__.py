...
# v7.5原生
try: from .crowding_detector import SignalCrowdingDetector, CrowdingConfig
except ImportError: SignalCrowdingDetector = None; CrowdingConfig = None
try: from .signal_fusion_v59 import SignalFusion
except ImportError: SignalFusion = None
...
__all__ = [
    'SignalCrowdingDetector', 'CrowdingConfig', 'SignalFusion',
    'SignalFusionEngine', 'EnhancedSignalFusion', 'SignalIndependenceAnalyzer',
    'SignalAuditor', 'RuleEngine',
    'SignalHalfLifeManager', 'SignalHalfLife', 'PRESET_HALF_LIVES',
]
