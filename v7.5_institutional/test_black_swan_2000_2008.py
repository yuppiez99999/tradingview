...
def simulate_defense(returns_df: pd.DataFrame,
    ...
    # 7.4 等级阈值 (来自 auto_hedge_executor.py:556-590)
    if mode == "v7.4":
        vix_l4 = 80.0
        vix_l3 = 60.0
        dd_l4 = 0.20
        ...
        # 分级对冲/减仓比例 (auto_hedge_executor.py:604-611, 752-759)
        hedge_ratio_by_level = {0: 0.30, 1: 0.30, 2: 0.50, 3: 0.70, 4: 0.90}
        equity_ratio_by_level = {0: 1.00, 1: 0.50, 2: 0.45, 3: 0.30, 4: 0.20}
