...
print(f"{'Window1 Sharpe':<18} {'-':<12} {'0.330':<12} {f'{windows[1][\"sharpe\"]:.3f}':<14} {f'{windows[1][\"sharpe\"]-0.330:+.3f}':<10}")
print(f"{'Window2 Sharpe':<18} {'-':<12} {'1.725':<12} {f'{windows[2][\"sharpe\"]:.3f}':<14} {f'{windows[2][\"sharpe\"]-1.725:+.3f}':<10}")
print("=" * 70)
