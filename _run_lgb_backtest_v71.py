...
print(f"V7.1 信号惩罚: regime==bull 且 vol20>4.5% 且 signal>0 -> signal *= 0.5")
print(f"V7.1 目标: 定向降低 2024-06 的 688017/300308 权重")
print(f"止盈规则: 单标的>50%->x0.6, 组合>12%->x0.80 (与V6.2/V7-Model一致)")
print(f"模式: resume=False (强制LGB重训, 应用V7.1信号惩罚)")
print()
