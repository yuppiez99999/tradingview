...
class TestHedgeRebalanceDataClasses:
    ...
    def test_position_weight_defaults(self) -> None:
        ...
        pw = PositionWeight(
            ...
            target_weight=0.1, current_weight=0.12,
            deviation=0.02, deviation_pct=0.2,
            current_value=120_000, target_value=100_000,
            adjustment=-20_000, adjustment_shares=-11,
    ...
    def test_hedge_decision_defaults(self) -> None:
        from utils.hedge_rebalance_integrator import HedgeDecision, HedgeMode, MarketRegime
