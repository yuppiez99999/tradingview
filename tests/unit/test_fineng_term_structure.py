...
def test_linear_term_structure_interp_and_extrap():
    ...
    ts = LinearTermStructure(points=[RatePoint(0.0, 0.02), RatePoint(1.0, 0.03),
                                    RatePoint(5.0, 0.04)])
...
def test_from_points_heuristic():
    ...
    pts = [RatePoint(0.25, 0.018), RatePoint(0.5, 0.020), RatePoint(1.0, 0.023),
           RatePoint(2.0, 0.027), RatePoint(5.0, 0.032), RatePoint(10.0, 0.036)]
