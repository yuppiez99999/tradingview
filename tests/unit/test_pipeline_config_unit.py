...
class PipelineConfigTest:
        ...
        _apply_yaml(
            cfg,
            {
                ...
                "risk_monitor": {
                    ...
                    "kill_switch_l1_margin": 0.4,
                    "kill_switch_l2_margin": 0.6,
                    "kill_switch_l3_margin": 0.7,
    ...
    def test_apply_risk_monitor_full(self):
        ...
        _apply_risk_monitor(
            cfg,
            {
                ...
                "kill_switch_l1_margin": 0.45,
                "kill_switch_l2_margin": 0.55,
                "kill_switch_l3_margin": 0.85,
    ...
    def test_apply_logging_full(self):
        ...
        _apply_logging(
            cfg,
            {"level": "WARNING", "report_dir": "/tmp/reports", "memory_write": False},
        )
    ...
    def test_env_override_no_vars(self):
        ...
        env_keys = [
            "PIPELINE_MODE",
            "PIPELINE_ALPHA_ENABLED",
            "PIPELINE_EXECUTION_ENABLED",
            "PIPELINE_RISK_INTERVAL",
            "PIPELINE_REPORT_DIR",
        ]
        clean_env = {
            k: v for k, v in __import__("os").environ.items() if k not in env_keys
        }
