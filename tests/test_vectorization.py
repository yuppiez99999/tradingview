...
assert orig_violations == vect_violations, f"因子违反列表不匹配: {orig_violations} vs {vect_violations}"
...
# 测试价格重建性能
large_rets = pd.Series(np.random.randn(500) * 0.02, index=pd.date_range('2020-01-01', periods=500))
