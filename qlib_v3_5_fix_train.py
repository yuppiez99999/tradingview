# -*- coding: utf-8 -*-
"""
QLib v3.5 修复版训练 — 内存优化 + 缩短时间范围

修复措施:
1. 添加 gc.collect() 清理内存
2. 将数据起始时间从2015改为2018，减少约30%行数
3. 保持94只股票训练池
4. 低学习率0.01 + 2000轮
"""
import os
...
def main():
    ...
    report_path = os.path.join(report_dir, f"qlib_v3_5_fix_train_{ts}.json")
    report = {
