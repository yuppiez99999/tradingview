# 首批次流水线跑批报告 - fifth_batch_20260725_112451

> CIO 视角批次质量评估（v1.0）
> 生成时间：2026-07-25 11:24:56

## 1. 批次基本信息

| 项目 | 值 |
|------|----|
| batch_id | `fifth_batch_20260725_112451` |
| 开始时间 | 2026-07-25T11:24:51.966615 |
| 结束时间 | 2026-07-25T11:24:56.832101 |
| 数据标的数 | 23 |
| 候选因子总数 | 16 |
| n_trials (多重检验基数) | 23 |
| portfolio_value | 1e8 |
...
|---|------|---------|------------|----------|--------|---------|----------|--------|--------------|-----------|
| 1 | `VT_MOM_ACCEL_5_20` | rejected | 0.685 | -0.079 | - | - | - | - | -/- | - |
| 2 | `VT_MOM_OVERNIGHT_GAP` | rejected | 0.608 | -0.128 | - | - | - | - | -/- | - |
| 3 | `VT_MOM_AUTOCORR_5D` | rejected | 0.452 | -0.180 | - | - | - | - | -/- | - |
| 4 | `VT_MOM_HIGH_VOL_ALPHA` | rejected | 0.605 | 0.065 | - | - | - | - | -/- | - |
| 5 | `VT_REV_BREADTH_5D` | rejected | 0.649 | 0.125 | - | - | - | - | -/- | - |
| 6 | `VT_REV_VOL_DRAIN` | rejected | 0.661 | -0.202 | - | - | - | - | -/- | - |
...
| 10 | `VT_VOL_OVERNIGHT_RATIO` | rejected | 0.469 | -0.151 | - | - | - | - | -/- | - |
...
完整流水线状态持久化于：
```
reports/vibe_trading/fifth_batch_20260725_112451/pipeline_state.json
```
