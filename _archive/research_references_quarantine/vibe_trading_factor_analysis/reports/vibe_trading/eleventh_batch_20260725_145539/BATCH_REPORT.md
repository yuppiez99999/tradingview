# 第十一批次流水线跑批报告 - eleventh_batch_20260725_145539

> P2.2 v5 最终改进验证（差异化极端值处理方案）
> 生成时间：2026-07-25 14:56:07

## 1. 批次基本信息

| 项目 | 值 |
|------|----|
| batch_id | `eleventh_batch_20260725_145539` |
| 数据标的数 | 105 |
| 候选因子总数 | 28 |
| n_trials | 105 |
...
| VT_QUALTREND_GROWTH_ACCEL | rejected | 0.292 (MOM_20D) | +0.2676 | 0.292 (MOM_20D) | +0.2676 | -0.000 | +0.0000 | ✅ | ❌ |
