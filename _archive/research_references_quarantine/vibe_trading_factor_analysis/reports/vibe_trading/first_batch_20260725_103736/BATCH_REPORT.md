# 首批次流水线跑批报告 - first_batch_20260725_103736

> CIO 视角批次质量评估（v1.0）
> 生成时间：2026-07-25 10:38:26

## 1. 批次基本信息

| 项目 | 值 |
|------|----|
| batch_id | `first_batch_20260725_103736` |
| 开始时间 | 2026-07-25T10:37:36.367958 |
| 结束时间 | 2026-07-25T10:37:38.468686 |
| 数据标的数 | 23 |
| 候选因子总数 | 16 |
| n_trials (多重检验基数) | 16 |
| portfolio_value | 1e8 |
...
| Gate | 通过数 | 通过率 | 说明 |
|------|--------|--------|------|
| G1 正交性 | 9 | 56.2% | 与现有 50+ 因子相关性 \|corr\| < 0.5 |
...
| 4 | `VT_MOM_HIGH_LOW_60D` | rejected | 0.687 | 0.072 | - | - | - | - | -/- | - |
| 5 | `VT_REV_SHORT_TERM` | rejected | 1.000 | - | - | - | - | - | -/- | - |
| 6 | `VT_REV_VOLUME_SPIKE` | rejected | 0.954 | - | - | - | - | - | -/- | - |
| 7 | `VT_REV_OVERREACTION` | rejected | 0.535 | 0.205 | - | - | - | - | -/- | - |
| 8 | `VT_LIQ_AMIHUD_SCALED` | rejected | 0.699 | 0.162 | - | - | - | - | -/- | - |
| 9 | `VT_LIQ_TURNOVER_REGIME` | rejected | 0.650 | 0.133 | - | - | - | - | -/- | - |
...
完整流水线状态持久化于：
```
reports/vibe_trading/first_batch_20260725_103736/pipeline_state.json
```
