...
print("V6.2止盈规则: 单标的>50%→×0.6, 组合>12%→×0.80 (V6原: 组合>12%→×0.85)")
print("模式: resume=True (复用V6/V6.1 LGB缓存, 仅重新应用V6.2止盈规则)")
print()
print("对比基准:")
print("  V6   (12%/×0.85): Sharpe CV=0.46 PASS, DSR n_trials=3 FAIL, 去极端月=8.92% PASS")
print("  V6.1 (10%/×0.80): Sharpe CV=0.55 FAIL, DSR n_trials=5 PASS, 去极端月=6.48% FAIL")
print("  V6.2 (12%/×0.80): 期望 Sharpe CV<0.5 AND DSR n_trials>=5 AND 去极端月>=8%")
print()
