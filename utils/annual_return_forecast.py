...
迁移说明 (2026-08-09 G5 物理隔离):
  本模块原位于 research/ 目录, 但因仅依赖 utils.risk_params (无 research 内部依赖),
...
# 路径常量
# ============================================================
# 注意: 本文件位于 utils/ 子目录, PROJECT_ROOT 必须上溯一级到项目根目录.
# 旧代码用 Path(__file__).resolve().parent 指向 utils/, 导致
# PLAN_DIR/REPORTS_DIR 变成 utils/v8.3_institutional/... (不存在),
