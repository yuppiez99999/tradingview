...
_BUILTIN_SPECS: list[ContractSpec] = [
    ...
    ContractSpec(
        product="CU", name="沪铜期货", exchange="SHFE",
        multiplier=5, margin_rate=0.09, tick_size=10,
        price_unit="元/吨", unit="吨",
        asset_type="COMMODITY_FUTURE", purpose="new_energy_demand", default_direction="long",
    ),
    ContractSpec(
        product="AU", name="黄金期货", exchange="SHFE",
        multiplier=1000, margin_rate=0.06, tick_size=0.02,
        price_unit="元/克", unit="克",
        asset_type="COMMODITY_FUTURE", purpose="safe_haven", default_direction="long",
    ),
    ContractSpec(
        product="T", name="10年国债期货", exchange="CFFEX",
        multiplier=10_000, margin_rate=0.02, tick_size=0.005,
        price_unit="元", unit="",
        asset_type="BOND_FUTURE", purpose="rate_directional", default_direction="short",
    ),
    # --- 来源 2 补充: managers.SUPPORTED_COMMODITIES 中未在来源 1 出现的品种 ---
    ContractSpec(
        product="AG", name="白银期货", exchange="SHFE",
        multiplier=15, margin_rate=0.07, tick_size=1,
        price_unit="元/千克", unit="千克",
        asset_type="COMMODITY_FUTURE", purpose="precious_metal", default_direction="long",
    ),
    ContractSpec(
        product="SC", name="原油期货", exchange="INE",
        multiplier=1000, margin_rate=0.10, tick_size=0.1,
        price_unit="元/桶", unit="桶",
        asset_type="COMMODITY_FUTURE", purpose="energy", default_direction="long",
    ),
    ContractSpec(
        product="I", name="铁矿石期货", exchange="DCE",
        multiplier=100, margin_rate=0.10, tick_size=0.5,
        price_unit="元/吨", unit="吨",
        asset_type="COMMODITY_FUTURE", purpose="steel_chain", default_direction="long",
    ),
    ContractSpec(
        product="RB", name="螺纹钢期货", exchange="SHFE",
        multiplier=10, margin_rate=0.09, tick_size=1,
        price_unit="元/吨", unit="吨",
        asset_type="COMMODITY_FUTURE", purpose="construction", default_direction="long",
    ),
    ContractSpec(
        product="M", name="豆粕期货", exchange="DCE",
        multiplier=10, margin_rate=0.07, tick_size=1,
        price_unit="元/吨", unit="吨",
        asset_type="COMMODITY_FUTURE", purpose="agriculture", default_direction="long",
    ),
    ContractSpec(
        product="Y", name="豆油期货", exchange="DCE",
        multiplier=10, margin_rate=0.07, tick_size=2,
        price_unit="元/吨", unit="吨",
        asset_type="COMMODITY_FUTURE", purpose="agriculture", default_direction="long",
    ),
    # --- 来源 3: 股指期货 (IF/IC/IH/IM) ---
    ContractSpec(
        product="IF", name="沪深300股指期货", exchange="CFFEX",
        multiplier=300, margin_rate=0.12, tick_size=0.2,
        price_unit="点", unit="",
        asset_type="INDEX_FUTURE", purpose="index_hedge", default_direction="long",
    ),
    ContractSpec(
        product="IC", name="中证500股指期货", exchange="CFFEX",
        multiplier=200, margin_rate=0.14, tick_size=0.2,
        price_unit="点", unit="",
        asset_type="INDEX_FUTURE", purpose="index_hedge", default_direction="long",
    ),
    ContractSpec(
        product="IH", name="上证50股指期货", exchange="CFFEX",
        multiplier=300, margin_rate=0.12, tick_size=0.2,
        price_unit="点", unit="",
        asset_type="INDEX_FUTURE", purpose="index_hedge", default_direction="long",
    ),
    ContractSpec(
        product="IM", name="中证1000股指期货", exchange="CFFEX",
        multiplier=200, margin_rate=0.14, tick_size=0.2,
        price_unit="点", unit="",
        asset_type="INDEX_FUTURE", purpose="index_hedge", default_direction="long",
    ),
