...
_MODE_IMPORTS = [
    ...
    (
        ...
        "cli.modes.hedge_rebalance_joint",
        "run_hedge_rebalance_joint",
    ),
    ...
    (
        ...
        "cli.modes.enhanced_training",
        "run_enhanced_training_mode",
    ),
    (
        "run_enhanced_prediction_mode",
        "cli.modes.enhanced_prediction",
        "run_enhanced_prediction_mode",
    ),
    ...
    (
        ...
        "cli.modes.stop_loss_config",
        "run_stop_loss_config_mode",
    ),
    (
        "run_ml_significance_mode",
        "cli.modes.ml_significance",
        "run_ml_significance_mode",
    ),
