...
def screenshot(name):
    filepath = f"auto_final_{name}_{int(time.time())}.png"
...
print("\n[2] 点击期权面板的合约输入框")
options_contract_x = left + width * 0.385
options_contract_y = top + height * 0.742
