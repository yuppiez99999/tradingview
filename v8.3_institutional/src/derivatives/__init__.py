...
try: from .futures_scan import FuturesQuote, FuturesTermStructure, ArbitrageSignal, OptionsSnapshot
except ImportError:
    FuturesQuote = None; FuturesTermStructure = None
    ArbitrageSignal = None; OptionsSnapshot = None
