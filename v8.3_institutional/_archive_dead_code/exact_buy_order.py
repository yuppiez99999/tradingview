...
def screenshot(name):
    filepath = f"exact_buy_{name}_{int(time.time())}.png"
...
time.sleep(3)
screenshot("after_buy_click")

print("\n[6] 再次点击买入按钮确保提交")
pyautogui.click(int(buy_x), int(buy_y))
time.sleep(3)
screenshot("after_buy_click_2")

print("\n[7] 等待确认弹窗")
time.sleep(2)
screenshot("after_wait_confirm")
...
time.sleep(2)
screenshot("after_enter_confirm")
